...
$page1['post_category'] = array($CATID);
$page1_id = wp_insert_post( $page1 );
update_post_meta($page1_id , '_wp_page_template', 'tpl-taxonomy.php');
...
add_post_meta($page1_id , '_wp_page_template', 'tpl-callback.php');
...
$page1['post_category'] = array($CATID);
$page1_id = wp_insert_post( $page1 );
update_post_meta($page1_id , 'type', 'store');
...
$page1 = array();
$page1['post_title'] = 'FAQ';
$page1['post_content'] = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut eros lectus, sollicitudin at vestibulum sit amet, elementum et libero. Mauris neque purus, consectetur eget vulputate quis, dapibus ac tortor. Vestibulum libero ante, porttitor eget ullamcorper id, imperdiet vel libero. Fusce nec turpis metus, nec venenatis lorem.';
$page1['post_status'] = 'publish';
$page1['post_type'] = 'page';
$page1['post_author'] = 1;
$page1['post_category'] = array($ARTID);
$page1_id = wp_insert_post( $page1 );
$pages_array .= $page1_id.",";
update_post_meta($page1_id , '_wp_page_template', 'tpl-faq.php');
...
update_option("advertising_footer_adsense", '<a href="http://www.'.''.'premiumpress.com/?source=auctionpress" target="_blank"><img src="http://www.premiumpress.com/banner/300x250.gif" alt="premium wordpress themes"  /></a>');
...
//$b = wp_insert_term("PremiumPress", "store" );
//update_option("store_".$b->term_id."_logo","example_store_0.png");
...
/******************************************************************
	VERSION 7 HOME PAGE OPTIONS
	****************************************************************/


$op[1] = 'carousel';
$op[2] = 'categories';
update_option('display_homecats_title','Website Categories');
update_option('ppt_object_recent_title','Recently Added Coupons');
update_option('ppt_object_recent_type','2');

$op[3] = 'recent';
 
//Array ( [0] => categories [1] => recent [2] => carousel [3] => widget [4] => hometext )

update_option('ppt_layout_block',$op);
update_option('ppt_layout_columns','1');
update_option('ppt_homepage_columns','1');
update_option("ppt_homepage_html","");	

// DEFAULT WIDGETS AND WHERE
update_option('sidebars_widgets','');
   
	
	$addWidget[0]['name'] = 'ppt-price-search';
	$addWidget[0]['sidebar'] = 'sidebar-1';
	$addWidget[0]['defaults'] = array('title'=>'Website Search', 'btn'=>'Start Search');
	
    $addWidget[1]['name'] = 'ppt-categories';
	$addWidget[1]['sidebar'] = 'sidebar-1';
	$addWidget[1]['defaults'] = array('title'=>'Website Categories', 'type'=>'post');
	
    $addWidget[2]['name'] = 'ppt-couponpress-popcoupons';
	$addWidget[2]['sidebar'] = 'sidebar-1';
	$addWidget[2]['defaults'] = array('title'=>'Popular Coupons','num'=>10);
	
    $addWidget[3]['name'] = 'ppt-articles';
	$addWidget[3]['sidebar'] = 'sidebar-1';
	$addWidget[3]['defaults'] = array('title'=>'Latest Articles','type'=>'full','articleID' => array());
	
	$addWidget[4]['name'] = 'fancy_text';
	$addWidget[4]['sidebar'] = 'sidebar-1';
	$addWidget[4]['defaults'] = array('title'=>''.PREMIUMPRESS_SYSTEM.' Version '.PREMIUMPRESS_VERSION.'', 'text'=>'Thank You For Purchasing <strong>'.PREMIUMPRESS_SYSTEM.'</strong> This is an example widget found in the new version for you to play with! ','background'=>'ftw-body-crumbled-paper-1','color'=>'#57bdcf','font'=>'ftw-font-schoolbell','icon' => 'ftw-graphics-tape-2','icon_position'=>'ftw-graphics-right','corners' => '');
